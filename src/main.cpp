...
static const int64_t nTargetTimespan = 10 * 60;  // 10m
unsigned int nTargetSpacing = 1 * 60; // RhomBit - 60 second blocks
static const int64_t nInterval = nTargetTimespan / nTargetSpacing;
static const int64_t nDiffChangeTarget = 1;

unsigned int nStakeMinAge = 2 * 60 * 60; // 2 hours
unsigned int nStakeMaxAge = -1;  // unlimited
unsigned int nModifierInterval = 10 * 60; // RhomBit - time to elapse before new modifier is computed
...
const string strMessageMagic = "RhomBit Signed Message:\n";
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // RhomBit: check proof-of-stake block signature
...
// RhomBit: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RhomBit", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Scientists baffled by 'impossible' ancient discovery on remote island 03/27/2019";
        CTransaction txNew;
        txNew.nTime = 1553684564;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
       ...
       if (false && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0x7338f7ec7a70f2a9ec6e5778f2df94723902540480a411bb0d2df17c3d4bd0f8"));
